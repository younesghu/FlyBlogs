    ...
    <section class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="mb-12">
            ...
            <ul class="list-disc pl-5 space-y-4">
                ...
                <li><strong>Contact Us:</strong> Have questions or need support? Reach out to mme via our contact form or email us directly at <a href="mailto:yourcontactemail@example.com" class="text-blue-600 underline">younes.guigaho.biz@gmail.com</a>. We’re here to help!</li>
            </ul>
        </div>

        <div class="text-center">
            <h2 class="text-3xl font-extrabold mb-8 text-blue-700">How It Works</h2>
            <ol class="list-decimal pl-6 space-y-4 text-left max-w-2xl mx-auto">
                <li class="bg-gray-100 p-4 rounded shadow-sm">
                    <strong class="text-lg text-blue-600"><a href="/register">Sign up</a></strong> Create an account to start using our platform. It's quick and easy!
                </li>
                <li class="bg-gray-100 p-4 rounded-sm">
                    <strong class="text-base text-blue-600">Create Your Blog:</strong> Use our editor to write and format your posts.
                </li>
                <li class="bg-gray-100 p-4 rounded-sm">
                    <strong class="text-lg text-blue-600">Publish and Share:</strong> Publish your content and share it with the world through social media.
                </li>
                <li class="bg-gray-100 p-4 rounded-sm">
                    <strong class="text-lg text-blue-600">Engage with Readers:</strong> Interact with your audience through comments and likes.
                </li>
                <li class="bg-gray-100 p-4 rounded-sm">
                    <strong class="text-lg text-blue-600">Manage and Analyze:</strong> Use our dashboard to manage your posts and view analytics.
                </li>
            </ol>
        </div>
        <div class="text-center mt-12">
            <h2 class="text-3xl font-bold mb-4">Join Us Today!</h2>
            <p class="text-lg">Start sharing your voice with the world on <strong class="text-blue-600">[Your Blog App Name]</strong>. We’re excited to have you on board and can’t wait to see what you create!</p>
        </div>
    </section>
@endsection
