...
@section('content')
    <section class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="text-center">
            <h2 class="text-3xl font-extrabold mb-8">How It Works</h2>
        ...
        <div class="text-center mt-12">
            <h2 class="text-3xl font-extrabold mb-6">Join Us Today!</h2>
            <p class="text-lg">Start sharing your voice with the world on <strong>Blog Wave</strong>. We’re excited to have you on board and can’t wait to see what you create!</p>
        </div>
    </section>
@endsection
